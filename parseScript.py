...
# savePath = sys.argv[2] if len(sys.argv) > 2 else "students_courses.csv"
filePaths = ["UnofficialTranscript.pdf"]
savePath = "students_courses.csv"
...
def processPdf(filePaths):
    try:
        ...
        for student in allStudentList:
            ...
            # Assuming you have all your regex patterns like termLineRE, courseRE, etc., already compiled
